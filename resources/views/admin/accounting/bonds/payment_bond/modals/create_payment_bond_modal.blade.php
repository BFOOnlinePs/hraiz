                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="text" name="amount" class="form-control text-center" style="background-color: palegoldenrod;font-size: 50px;height: 80px !important;vertical-align: middle;padding-top: 25px" pattern="[0-9]+" title="يجب ادخال ارقام فقط" placeholder="قيمة سند الدفع">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
